...
// ---------------------------------------------------------------------------
// These constants must match what the scheduler expects.
static constexpr char HINT_NONE = 0;
static constexpr char HINT_LATENCY_SENSITIVE = 1;  // = CueHint::kBoost
static constexpr char HINT_BATCH = 2;              // = CueHint::kYield
